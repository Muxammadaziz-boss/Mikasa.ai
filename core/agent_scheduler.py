...
class ScheduledTask:
    ...
    def __init__(self, task_id: str, run_at: datetime.datetime, 
                 task_type: str, data: dict, repeat_seconds: int = 0):
    ...
    def from_dict(cls, d: dict) -> 'ScheduledTask':
        ...
        task.created_at = datetime.datetime.fromisoformat(d.get("created_at", datetime.datetime.now().isoformat()))
        return task
...
class AgentScheduler:
    ...
    def __init__(self):
        ...
        self._file = os.path.join(BASE_DIR, "scheduled_tasks.json")
        self._running = False
        self._thread = None
    ...
    def add(self, task_type: str, data: dict, 
            run_at: datetime.datetime = None,
            delay_seconds: int = 0, 
            repeat_seconds: int = 0) -> str:
    ...
    def _execute_task(self, task: ScheduledTask):
        ...
        try:
            ...
            if task.repeat_seconds > 0:
                ...
                task.run_at = datetime.datetime.now() + datetime.timedelta(seconds=task.repeat_seconds)
