...
# # ========== AI orqali tushunish va amalni bajarish ==========
...
#         ruxsat_etilgan = [
#             "greeting", "time", "date", "weather", "reminder", "reminders", "shutdown", "restart", "lock",
#             "desktop", "taskmgr", "memory", "screenshot", "new_file", "caps_lock", "enter", "backspace",
#             "tab", "switch_window", "volume_up", "volume_down", "volume_mute", "volume_unmute", "search",
#             "open_discord", "open_telegram", "open_code", "open_chrome", "open_brave", "open_youtube",
#             "youtube_first_video", "music_search", "select_next_item", "unknown"
#         ]

#         prompt = f"""
# Siz quyidagi foydalanuvchi so'zini tushunib, quyidagi buyruqlardan birini qaytarishingiz kerak.
# Agar so'zga mos buyruq topilmasa, "unknown" qaytaring.
