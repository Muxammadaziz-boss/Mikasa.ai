...
class AnimatedButton(ctk.CTkButton):
    """Soddalashtirilgan animatsiyali tugma"""
...
def gui_ishga_tushir(foydalanuvchi_ismi, ovoz_turi, fon_xizmat_func, register_callback_func=None):
